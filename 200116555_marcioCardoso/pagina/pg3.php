...
<body>
<header class="header">
					<h1>Bolos de Pote3</h1>
					
					<a href="pg2.php?p=quemSomos"><button style="background: #069cc2; border-radius: 6px; padding: 15px; cursor: pointer; color: #fff; border: none; font-size: 16px;">Quem Somos</button></a>
					...
					<a href="/200116555_marcioCardoso/index.php?p=home"><button style="background: #069cc2; border-radius: 6px; padding: 15px; cursor: pointer; color: #fff; border: none; font-size: 16px;">home</button></a>
				</header>
                <p>Telefone:(55)9999.9999</p>
				...
				<footer>
<div class="container">
    				<img src="/200116555_marcioCardoso/images/bo3.jpeg" width="320" height="205" />
				</div>
</footer>
<p>
